...
## Distance to Nearest Nieghbor
```{r}
distance = function(data){
  earth_radius_in_miles = 3959
  n = nrow(data)
  locs = as.matrix(data[1:n,c("NormalLONG", "NormalLAT")])
...
plot(density(distance(dat_att[dat_att$Type == "Non-Rural",])), main="Distance to Nearest Nieghbor", lwd =3, col="blue")
lines(density(distance(dat_att[dat_att$Type == "Rural",])), main="Distance to nearest nieghbor\nUrban", col="green3", lwd=3)
```
...
plot(att$Sig_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(6, 11), pch=19, ylab="absolute prediction error", main="SigStrength Error")
points(att_rural$Sig_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$Sig_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$SigStrength - median(dat_att$SigStrength))), lty = 2, col = "red", lwd=3)
grid()

plot(att$wMOS_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(0, 0.1), pch=19, ylab="absolute prediction error", main="wMOS Error")
points(att_rural$wMOS_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$wMOS_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$wMOS - median(dat_att$wMOS))), lty = 2, col = "red", lwd=3)
grid()

plot(att$wTCPDown_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(8, 12), pch=19, ylab="absolute prediction error", main="wTCPDown Error")
points(att_rural$wTCPDown_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$wTCPDown_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$wTCPDown - median(dat_att$wTCPDown)))/1000, lty = 2, col = "red", lwd=3)
grid()

plot(att$wTCPUp_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(4, 7), pch=19, ylab="absolute prediction error", main="wTCPUp Error")
points(att_rural$wTCPUp_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$wTCPUp_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$wTCPUp - median(dat_att$wTCPUp)))/1000, lty = 2, col = "red", lwd=3)
grid()
```
...
```{r}
layout(matrix(c(1,2,3,4), 2, 2, byrow = TRUE))
plot(att$Sig_weighted_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(6, 11), pch=19, ylab="absolute prediction error", main="SigStrength Error")
points(att_rural$Sig_weighted_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$Sig_weighted_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$SigStrength - median(dat_att$SigStrength))), lty = 2, col = "red", lwd=3)
grid()

plot(att$wMOS_weighted_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(0, 0.1), pch=19, ylab="absolute prediction error", main="wMOS Error")
points(att_rural$wMOS_weighted_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$wMOS_weighted_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$wMOS - median(dat_att$wMOS))), lty = 2, col = "red", lwd=3)
grid()

plot(att$wTCPDown_weighted_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(8, 12), pch=19, ylab="absolute prediction error", main="wTCPDown Error")
points(att_rural$wTCPDown_weighted_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$wTCPDown_weighted_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$wTCPDown - mean(dat_att$wTCPDown)))/1000, lty = 2, col = "red", lwd=3)
grid()

plot(att$wTCPUp_weighted_knn_error, type = "b", col="black", lwd=3, xlab = "k", ylim=c(4, 7), pch=19, ylab="absolute prediction error", main="wTCPUp Error")
points(att_rural$wTCPUp_weighted_knn_error, type = "b", col="green3", lwd=3, pch=19)
points(att_urban$wTCPUp_weighted_knn_error, type = "b", col="blue", lwd=3, pch=19)
abline(h = median(abs(dat_att$wTCPUp - median(dat_att$wTCPUp)))/1000, lty = 2, col = "red", lwd=3)
grid()
```
...
kNN = function(X_test, k, data){
  ...
  for(i in 1:nrow(X_test)){
    ...
    dist = distHaversine(temp, locs, r=earth_radius_in_miles)
    kNearest = order(dist)[1:k]
    weights = 1/sort(dist[kNearest] + 0.001)
    weights = weights/sum(weights)
    predicted = c(predicted, sum(weights * data$wTCPDown[kNearest]))
  }
...
zhat_knn2=matrix(0,length(xrang),length(yrang))
zhat_knn3=matrix(0,length(xrang),length(yrang))
zhat_knn5=matrix(0,length(xrang),length(yrang))
zhat_knn10=matrix(0,length(xrang),length(yrang))
zhat_knn20=matrix(0,length(xrang),length(yrang))
...
ztarg_knn2 = kNN(data.frame(NormalLONG=xtarg[!is.na(xtarg)], NormalLAT=ytarg[!is.na(ytarg)]), 2, ctrl)
ztarg_knn3 = kNN(data.frame(NormalLONG=xtarg[!is.na(xtarg)], NormalLAT=ytarg[!is.na(ytarg)]), 3, ctrl)
...
ztarg_knn20 = kNN(data.frame(NormalLONG=xtarg[!is.na(xtarg)], NormalLAT=ytarg[!is.na(ytarg)]), 20, ctrl)
...
for(j in 1:length(yrang)){
  for(i in 1:length(xrang)){
    if(point.in.polygon(xrang[i], yrang[j], ca$long, ca$lat)){
      ...
      zhat_knn2[i,j]=ztarg_knn2[t]
      zhat_knn3[i,j]=ztarg_knn3[t]
      zhat_knn5[i,j]=ztarg_knn5[t]
      zhat_knn10[i,j]=ztarg_knn10[t]
      zhat_knn20[i,j]=ztarg_knn20[t]
    }
    else{
      zhat_knn1[i,j]=0
      zhat_knn2[i,j]=0
...
image(xrang, yrang, zhat_knn1, col=rainbow(80)[51:5], xlab="Longitude", ylab="Latitude", main="k=1")
lines(ca, lwd=2)

image(xrang, yrang, zhat_knn2, col=rainbow(80)[51:5], xlab="Longitude", ylab="Latitude", main="k=2")
lines(ca, lwd=2)

image(xrang, yrang, zhat_knn3, col=rainbow(80)[51:5], xlab="Longitude", ylab="Latitude", main="k=3")
lines(ca, lwd=2)

image(xrang, yrang, zhat_knn5, col=rainbow(80)[51:5], xlab="Longitude", ylab="Latitude", main="k=5")
lines(ca, lwd=2)

image(xrang, yrang, zhat_knn10, col=rainbow(80)[51:5], xlab="Longitude", ylab="Latitude", main="k=10")
lines(ca, lwd=2)

image(xrang, yrang, zhat_knn20, col=rainbow(80)[51:5], xlab="Longitude", ylab="Latitude", main="k=20")
lines(ca, lwd=2)
```
...
layout(matrix(c(1,2,3,4), 2, 2, byrow = TRUE))
plot(Sig_variogram$exp_var$gamma~Sig_variogram$exp_var$dist, type="l", lwd=4, ylim=c(0,0.07), col="steelblue3", ylab="semi-varience", xlab="distance", main="Signal Strength")
plot(wMOS_variogram$exp_var$gamma~Sig_variogram$exp_var$dist, type="l", lwd=4, ylim=c(0,0.07), col="steelblue3", ylab="semi-varience", xlab="distance", main="wMOS")
plot(wTCPDown_variogram$exp_var$gamma~Sig_variogram$exp_var$dist, type="l", lwd=4, ylim=c(0,0.07), col="steelblue3", ylab="semi-varience", xlab="distance", main="wTCPDown")
plot(wTCPUp_variogram$exp_var$gamma~wTCPUp_variogram$exp_var$dist, type="l", lwd=4, ylim=c(0,0.07), col="steelblue3", ylab="semi-varience", xlab="distance", main="wTCPUp")
```
...
layout(matrix(1:4,ncol=2), width = c(3,3,3),height = c(1,1))
par(mar=c(5,5,3,2))
